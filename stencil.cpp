...
void Stencil::ApplyStencilOperator(const MultiIndexType& gridreadbegin, const MultiIndexType& gridreadend,
		                           const MultiIndexType& gridwritebegin, const MultiIndexType& gridwritee,
...
//					sum += 1 ;//sourcegridfunction.getGridfunction()[i-k-int((stencilwidth-1)/2)]
					          //                                  [j-l-int((stencilwidth-1)/2)]*
					//		stencil[k][l];/
//				}
//			}
